...
Decidimos dejar los archivos con algunos datos de prueba para tener al alcance para probar, para empezar de cero puede borrarlos para que se vuelvan a generar (menos el de config.txt)
